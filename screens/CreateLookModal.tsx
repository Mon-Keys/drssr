...
import {
    StyleSheet,
    Platform,
    StatusBar, Text, Pressable, FlatList, Image
} from 'react-native';
...
import {
    BottomSheetModal,
    BottomSheetModalProvider, TouchableOpacity
...
export default function CreateLookModal(/*{
    ...
    const [itemsAvail, setItemsAvail] = React.useState<Array<ItemMock>>([
        {
            id: '1',
    ...
    const Item = ({data}: {data: ItemMock}) => {
        ...
        const [resizedImage, setResizedImage] = React.useState<null | Response>();
        ...
        return (
            ...
            <TouchableOpacity
                ...
                delayLongPress={300}>
                <Image style= {{height: 100,width: 100}} source={{uri: data.image}} />
                {resizedImage ? (
                    <>
                        <Image
                            style={{height: 250,
    ...
    <BottomSheetModalProvider>
        <View style={styles.container}>
            <Pressable style={{top: 20,left: 20, width: 60,height:60}} onPress={openModal}>
                <AntDesign
                    name="pluscircle"
                    size={36}
            ...
            <View style={styles.lookArea}>
                {naebka ? <Image style={{width: 200, height:200}} source={{uri: 'https://images.squarespace-cdn.com/content/v1/51c322cfe4b032aad705a0fc/1642096058736-J6V8HNHZOH0BODMNOM2J/G185B_Black_FF.png?format=1000w'}}/>: null}
                {naebka}
