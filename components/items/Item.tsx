    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                <Text>
                    {item.description ||
                        'Облегающее платье длиной до середины икры из трикотажа. Модель без рукавов с тонкими регулируемыми бретелями, вырезом в форме сердца и формованными чашечками. Плоские швы, завернутые спереди и сзади. Отрез на талии и прямой низ.'}
                </Text>
            </View>
        </View>
    );
