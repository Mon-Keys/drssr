...
const Cheap = (props: CheapProps) => {
    ...
    const fadeToBlack = (callback: ((event: GestureResponderEvent) => void) | undefined) => {
        // @ts-ignore
    ...
    return (
        <SafeAreaView>
            <Animated.View style={{opacity: fadeAnim}}>
                ...
                <Animated.View style={props.isActive ? {...styles.active, backgroundColor: boxInterpolationWhite} : {...styles.inactive,backgroundColor: boxInterpolation}} {...props} >
                    <Animated.Text style={props.isActive ? {...styles.activeTitle, color: boxInterpolation}: {...styles.inactiveTitle, color: boxInterpolationWhite}}> {props.title} </Animated.Text>
                </Animated.View>
                </Pressable>
            </Animated.View>
